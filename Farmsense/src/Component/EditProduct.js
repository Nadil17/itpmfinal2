...
const EditProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`http://localhost:8080/auth/products/${id}`, formData, {
      headers: {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-2xl text-center">
          <p className="text-red-500 text-2xl font-bold mb-4">Error Loading Product</p>
          <p className="text-gray-700">{error.message || "Unable to fetch product details"}</p>
        </div>
      </div>
    );
  ...
  if (!product)
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-2xl text-center">
          <p className="text-yellow-500 text-2xl font-bold mb-4">Product Not Found</p>
          <p className="text-gray-700">The requested product does not exist.</p>
        </div>
      </div>
    );
